...
function propertyRoutes(){
  ...
  async function build(){
    ...
    const problems = [];
    const q = (label, sql, params) => db.q(sql, params).then(r2 => r2.rows).catch(err => {
...
module.exports = { propertyRoutes, invalidate: () => invalidateProperties() };
